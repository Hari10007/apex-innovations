                ...
                <div className="row gy-3">
                    ...
                    <div className='col-9'>
                        <Autocomplete
                            ...
                            value={formik.values.Employees.map((email) => employees.find((employee) => employee.email === email))}
                    ...
                    <div className='col-9 my-5'>
                        <Button variant="contained" color="primary" type="submit">Create Project</Button>
                    </div>
                </div>
            </div>
        </Form>
